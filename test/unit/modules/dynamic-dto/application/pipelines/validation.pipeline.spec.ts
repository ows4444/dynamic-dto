...
import { ValidationStrategyFactory } from '@src/modules/dynamic-dto/infrastructure/factories/validation-strategy.factory';
import type { ValidationChain } from '@src/modules/dynamic-dto/core/patterns/validation-chain';
import type { ValidationResult } from '@src/index';
import { DynamicSchemaEntity, FieldType } from '@src/index';
import type { ValidationContext } from '@src/modules/dynamic-dto/core';
...
describe('ValidationPipeline', () => {
  ...
  describe('getAvailableStrategies', () => {
    ...
    it('should map strategy objects to names correctly', () => {
      // Arrange
      validationStrategyFactory.getAllStrategies.mockReturnValue([{ name: 'strategy1', order: 1 } as any, { name: 'strategy2', order: 2 } as any, { name: 'strategy3', order: 3 } as any]);
