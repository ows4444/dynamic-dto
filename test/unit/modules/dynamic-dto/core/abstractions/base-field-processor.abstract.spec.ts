...
describe('BaseFieldProcessor', () => {
  ...
  describe('validateSchemaStructure', () => {
    ...
    it('should throw error for missing type', () => {
      ...
      expect(() => processor.validateSchemaStructure(invalidSchema)).toThrow('Invalid schema: missing or invalid type property');
    });
    ...
    it('should throw error for mismatched type', () => {
      ...
      expect(() => processor.validateSchemaStructure(invalidSchema)).toThrow('Schema type mismatch: expected string, got number');
    });
  });
  ...
  describe('ensureType', () => {
    ...
    it('should throw error if type guard fails', () => {
      ...
      expect(() => processor['ensureType'](schema, failingTypeGuard)).toThrow('Schema does not match expected type constraints');
    });
  });
